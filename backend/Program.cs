...
// Servir archivos estáticos desde la carpeta principal del frontend ('carpeta')
var staticFilesPath = Path.GetFullPath(Path.Combine(builder.Environment.ContentRootPath, "..", "carpeta"));
if (Directory.Exists(staticFilesPath))
{
    app.UseStaticFiles(new StaticFileOptions
    {
        FileProvider = new PhysicalFileProvider(staticFilesPath),
        RequestPath = string.Empty // servir en la raíz: /archivoshtml/...
    });
}
...
// Middleware de logging de peticiones para depuración
